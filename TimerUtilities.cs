...
{
    /// <summary>
    /// Utility methods for Timers.
    /// </summary>
    public static class TimerUtilities
    {
        /// <summary>
        /// Utility method for checking if the timer is alive safely. 
        /// </summary>
        /// <param name="timer"></param>
        /// <returns>True if timer is not null and alive.<br></br>False if timer is null or not alive.</returns>
        public static bool IsAliveAndNotNull(this Timer timer)
        {
